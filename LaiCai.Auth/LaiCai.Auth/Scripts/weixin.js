	...
	function() {
		...
		location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function() {
			...
			i.go("chat"), e.CONF = m, t.isUnLogin = !window.MMCgi.isLogin, t.debug = !0, t.isShowReader = /qq\.com/gi.test(location.href), window.MMCgi.isLogin && (N(), h.browser.chrome && !MMDEV && (window.onbeforeunload = function(e) {
				return e = e || window.event, e && (e.returnValue = "πÿ±’‰Ø¿¿∆˜¡ƒÃÏƒ⁄»›Ω´ª·∂™ ß°£"), "πÿ±’‰Ø¿¿∆˜¡ƒÃÏƒ⁄»›Ω´ª·∂™ ß°£"
			...
			function o(c) {
				...
				case 200:
					t.newLoginPage(c.redirect_uri).then(function(t) {
						...
						return u ? void(window.location.href = u[1]) : o && "0" != o[1] ? (alert(f && f[1] || "µ«¬Ω ß∞‹"), i.report(i.AUTH_FAIL_COUNT, 1), void location.reload()) : (e.$emit("newLoginPage", {
							Ret: o && o[1],
							SKey: c && c[1],
							Sid: s && s[1],
							Uin: l && l[1],
							...
							return K.md5File(e).then(function(t) {
								...
								if (i) {
									...
									d = angular.extend({}, u), n({
										...
										e.MMSendMsg && (e.MMSendMsg.MMFileStatus = r.MM_SEND_FILE_STATUS_FAIL, e.MMSendMsg.MMStatus = r.MSG_SEND_STATUS_FAIL), alert("…œ¥´ ß∞‹")
									})
				...
				n.open({
					...
					controller: ["$scope", function(e) {
						e.content = "", e.send = function() {
							var t = "°æ–¬∞ÊwebŒ¢–≈°ø°æ" + navigator.userAgent.toLowerCase() + "°ø" + e.content;
		...
		angular.module("Controllers").controller("transpondDialogController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function(e, t, a, n, i, o, r, c, s, l, d, f, u, m, g, p) {
			...
			v.unshift({
				...
				if (e > 0) {
					...
					if (e > 200) return void alert("—°‘Òµƒ»À ˝±ÿ–Î…Ÿ”⁄200");
					t.comfirming = !0
				}
			}
		}])
			...
			var _chatList = [],
				...
				service = {
					...
					_appUnknowMsgProcess: function(e) {
						this._appAsTextMsgProcess(e, "[ ’µΩ“ªÃıÕ¯“≥∞ÊŒ¢–≈‘›≤ª÷ß≥÷µƒœ˚œ¢¿‡–Õ£¨«Î‘⁄ ÷ª˙…œ≤Èø¥]")
					},
					...
					revokemsg: function(e) {
						...
						$http({
							...
							0 == a.BaseResponse.Ret ? (angular.extend(e, {
								...
								_h: 0
							}), t.getChatList()) : alert(a.BaseResponse.ErrMsg || "≥∑ªÿ ß∞‹")
						}).error(function(e) {
							alert("≥∑ªÿ ß∞‹")
						})
					},
	...
	function() {
		...
		angular.module("Services").factory("emojiFactory", ["$http", "$q", "confFactory", "utilFactory", function(e, t, a, n) {
			var i = {
				...
				QQFaceList: ["Œ¢–¶", "∆≤◊Ï", "…´", "∑¢¥Ù", "µ√“‚", "¡˜¿·", "∫¶–ﬂ", "±’◊Ï", "ÀØ", "¥Ûøﬁ", "ﬁœﬁŒ", "∑¢≈≠", "µ˜∆§", "ﬂ⁄—¿", "æ™—»", "ƒ—π˝", "ø·", "¿‰∫π", "◊•øÒ", "Õ¬", "Õµ–¶", "”‰øÏ", "∞◊—€", "∞¡¬˝", "º¢∂ˆ", "¿ß", "æ™ø÷", "¡˜∫π", "∫©–¶", "”∆œ–", "∑‹∂∑", "÷‰¬Ó", "“…Œ ", "–Í", "‘Œ", "∑Ë¡À", "À•", "˜º˜√", "«√¥Ú", "‘Ÿº˚", "≤¡∫π", "øŸ±«", "πƒ’∆", "Ù‹¥Û¡À", "ªµ–¶", "◊Û∫ﬂ∫ﬂ", "”“∫ﬂ∫ﬂ", "π˛«∑", "±… ”", "ŒØ«¸", "øÏøﬁ¡À", "“ıœ’", "«◊«◊", "œ≈", "ø…¡Ø", "≤Àµ∂", "Œ˜πœ", "∆°æ∆", "¿∫«Ú", "∆π≈“", "øß∑»", "∑π", "÷ÌÕ∑", "√µπÂ", "µÚ–ª", "◊Ï¥Ω", "∞Æ–ƒ", "–ƒÀÈ", "µ∞∏‚", "…¡µÁ", "’®µØ", "µ∂", "◊„«Ú", "∆∞≥Ê", "±„±„", "‘¬¡¡", "Ã´—Ù", "¿ÒŒÔ", "”µ±ß", "«ø", "»ı", "Œ’ ÷", " §¿˚", "±ß»≠", "π¥“˝", "»≠Õ∑", "≤Óæ¢", "∞Æƒ„", "NO", "OK", "∞Æ«È", "∑…Œ«", "Ã¯Ã¯", "∑¢∂∂", "‚Êª", "◊™»¶", "øƒÕ∑", "ªÿÕ∑", "Ã¯…˛", "Õ∂Ωµ", "º§∂Ø", "¬“ŒË", "œ◊Œ«", "◊ÛÃ´º´", "”“Ã´º´"],
				EmojiList: ["–¶¡≥", "…˙≤°", "∆∆ÃÈŒ™–¶", "Õ¬…‡", "¡≥∫Ï", "ø÷æÂ", " ßÕ˚", "Œﬁ”Ô", "∫Ÿπ˛", "ŒÊ¡≥", "ºÈ–¶", "ª˙÷«", "÷Â√º", "“Æ", "πÌªÍ", "∫œ Æ", "«ø◊≥", "«Ï◊£", "¿ÒŒÔ", "∫Ï∞¸", "º¶", "ø™–ƒ", "¥Û–¶", "»»«È", "’£—€", "…´", "Ω”Œ«", "«◊Œ«", "¬∂≥›–¶", "¬˙“‚", "œ∑≈™", "µ√“‚", "∫π", "µÕ¬‰", "≈ﬁ", "Ωπ¬«", "µ£–ƒ", "’æ™", "ª⁄∫ﬁ", "—€¿·", "øﬁ", "‘Œ", "–ƒ∑≥", "…˙∆¯", "ÀØæı", "∂Òƒß", "Õ‚–«»À", "–ƒ", "–ƒÀÈ", "«±»Ãÿ", "…¡À∏", "–«–«", "Ãæ∫≈", "Œ ∫≈", "ÀØ◊≈", "ÀÆµŒ", "“Ù¿÷", "ª", "±„±„", "»ı", "»≠Õ∑", " §¿˚", "…œ", "œ¬", "”“", "◊Û", "µ⁄“ª", "Œ«", "»»¡µ", "ƒ–∫¢", "≈Æ∫¢", "≈Æ ø", "ƒ– ø", "ÃÏ π", "˜º˜√", "∫Ï¥Ω", "Ã´—Ù", "œ¬”Í", "∂‡‘∆", "—©»À", "‘¬¡¡", "…¡µÁ", "∫£¿À", "√®", "–°π∑", "¿œ Û", "≤÷ Û", "Õ√◊”", "π∑", "«‡Õ‹", "¿œª¢", "øº¿≠", "–‹", "÷Ì", "≈£", "“∞÷Ì", "∫Ô◊”", "¬Ì", "…ﬂ", "∏Î◊”", "º¶", "∆Û∂Ï", "√´≥Ê", "’¬”„", "”„", "æ®”„", "∫£Î‡", "√µπÂ", "ª®", "◊ÿÈµ ˜", "œ…»À’∆", "¿Ò∫–", "ƒœπœµ∆", " •µÆ¿œ»À", " •µÆ ˜", "¿ÒŒÔ", "¡Â", "∆¯«Ú", "CD", "œ‡ª˙", "¬ºœÒª˙", "µÁƒ‘", "µÁ ”", "µÁª∞", "Ω‚À¯", "À¯", "‘ø≥◊", "≥…Ωª", "µ∆≈›", "” œ‰", "‘°∏◊", "«Æ", "’®µØ", " ÷«π", "“©ÕË", "ÈœÈ≠«Ú", "¿∫«Ú", "◊„«Ú", "∞Ù«Ú", "∏ﬂ∂˚∑Ú", "Ω±±≠", "»Î«÷’ﬂ", "≥™∏Ë", "º™À˚", "±»ª˘ƒ·", "ª π⁄", "”Í…°", " ÷Ã·∞¸", "ø⁄∫Ï", "Ω‰÷∏", "◊Í Ø", "øß∑»", "∆°æ∆", "∏…±≠", "º¶Œ≤æ∆", "∫∫±§", " ÌÃı", "“‚√Ê", " ŸÀæ", "√ÊÃı", "ºÂµ∞", "±˘º§¡Ë", "µ∞∏‚", "∆ªπ˚", "∑…ª˙", "ªº˝", "◊‘––≥µ", "∏ﬂÃ˙", "æØ∏Ê", "∆Ï", "ƒ–»À", "≈Æ»À", "O", "X", "∞Ê»®", "◊¢≤·…Ã±Í", "…Ã±Í"],
				QQFaceMap: {
					"Œ¢–¶": "0",
					"∆≤◊Ï": "1",
					"…´": "2",
